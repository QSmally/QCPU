...
|------+-------+-------------------------------------------------------------|
| `00` |       | none                                                        |
| `01` | `idx` | general-purpose index register (`rx` and `ry`)              |
| `10` | `sf`  | stack frame (user or kernel depending on current context)   |
| `11` | `sp`  | stack pointer (user or kernel depending on current context) |

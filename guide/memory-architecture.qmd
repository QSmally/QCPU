...
description: "QCPU's 16 bit virtual memory, 24 bit partioned physical memory and addressing modes."
date: 2023-10-8
categories: [memory]
---
...
- Process mutable data (pid, uid, env, stack/frame/insertion pointers, mmap)

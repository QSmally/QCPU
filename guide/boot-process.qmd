...
_:                lui sp, @sbase rsht 8
                  bkpt
```

For allocating to the stack, use the `alloc` pseudoinstruction:

```
                  alloc -4                ; 4 bytes
                  mstw x1, sp, 0          ; sp+0/1 = x1
                  mstw x2, sp, 2          ; sp+2/3 = x2
```

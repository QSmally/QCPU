...
|-------------------------+---------------+-----------------+----------------+---------+----------------------------------|
| `jmp`                   | btb hit known |                 |                |         | jumped if btb miss, write to btb |
...
| fetch                                 | fetch         | decode | decode                                            | execute                               | writeback                            |
|---------------------------------------+---------------+--------+---------------------------------------------------+---------------------------------------+--------------------------------------|
| `brh c`                               | btb hit known |        |                                                   | recovery ready for taken -> not taken | jumped if mispredicted, write to btb |
...
cycles of fetching from the upper memory. The clock doesn't switch off during this time.
...
| fetch             | fetch                 | decode | decode         | execute | writeback         |
|-------------------+-----------------------+--------+----------------+---------+-------------------|
| `jmpr`            | btb miss              |        |                |         | jumped to address |

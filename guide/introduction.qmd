...
An accumulator clear could be `AST r; SUB r;` or `IMM ra, 0x00`.
:::
...
Memory instructions can use a known base address, also known as selectors. See
the memory architecture page for more information.

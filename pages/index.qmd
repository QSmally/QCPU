...
| `1-1010#-##` | **jmp**  | Jump to address                   | 2 | `pc = 'reg' + imm`                    |
| `1-1011#-##` | **jmpc** | Jump to address (and link)        | 2 | `push(pc, fb), pc = 'reg' + imm`      |
| `1-1100#-##` | **mst**  | Memory store                      | 2 | `*('reg' + imm) = acc`                |
| `1-1101#-##` | **mstl** | Memory store (indirect)           | 2 | `*('reg' + imm) = acc`                |
| `1-1110#-##` | **mld**  | Memory load                       | 2 | `acc = *('reg' + imm)`                |
| `1-1111#-##` | **mldl** | Memory load (indirect)            | 2 | `acc = *('reg' + imm)`                |

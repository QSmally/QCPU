...
|---------------+----------+-------------------------------------+---+--------------------------------------------------+------------------------------------------------------------|
| `0-0000-000`  | **sysc** | System call interrupt               | 2 | acc = imm, call int                              | interrupt performs link on kernel stack                    |
| `0-0000-001`  | **ret**  | Pull from stack and jump            | 1 | pcl, pch = \*2(sf); sfl, sfh = \*2(sf + 2)       | takes 4 memory reads, stalls                               |
| `0-0000-010`  | **msp**  | Allocate by mutating stack pointer  | 3 | sp += amount                                     | restore acc?                                               |
| `0-0000-011`  | **nta**  | NOT accumulator                     | 1 | acc = !acc                                       |                                                            |
| `0-0000-100`  | **bmr**  | Barrel shifter modifier: rotate     | 1 |                                                  |                                                            |
| `0-0000-101`  | **bms**  | Barrel shifter modifier: sign shift | 1 |                                                  |                                                            |
| `0-0000-110`  |          | Reserved                            |   |                                                  |                                                            |
| `0-0000-111`  |          | Reserved                            |   |                                                  |                                                            |
...
async memory readback register

mldw sf, 0x0000, amra               -- 4 bytes
                                    -- other operations
amr  mal                            -- load from mal/mah, stall if marked pending



mldw sf, 0x0000, amra               -- 4 bytes
mldw sf, 0x0002, amrb               -- 4 bytes
                                    -- other operations
amr  mal                            -- load from mal/mah, stall if marked pending
amr  mbl                            -- load from mbl/mbh, stall if marked pending

...
| `0-0000-011` | **lck**  | Interrupt lock (clear interrupt)   | 1 | `I = 0`                               |
| `0-0000-100` | **ulck** | Interrupt unlock (set interrupt)   | 1 | `I = 1`                               |
| `0-0000-101` |          |                                    |   |                                       |
| `0-0000-110` |          |                                    |   |                                       |
| `0-0000-111` |          |                                    |   |                                       |
| `0-0001-###` | **imm**  | Load immediate into register       | 2 | `'reg' = imm`                         |
| `0-0010-###` |          |                                    |   |                                       |
| `1-0011-###` | **msp**  | Mutate the stack pointer           | 1 | `spt = spt + 'offset' + 1`            |
...
| `0-1000-###` | **push** | Push register + immediate to stack | 2 | `push('reg' + imm)` ra = 0            |
